...
if __name__ == "__main__":
    ...
    for prune_percentage in [0.9, 0.8, 0.5]:
            ...
            print(f"FID between Full Syn-CIFAR100  and {int((1 - prune_percentage) * 100)}% Random Syn-CIFAR100 trainset: {fid_value:.4f}")
            ...
            print(f"FID between Syn-CIFAR100 and {int((1 - prune_percentage) * 100)}%  Stratified Syn-CIFAR100: {fid_value:.4f}")
            ...
            print(f"FID between Full Syn-CIFAR100  and Zcoreset Top {int((1 - prune_percentage) * 100)}% Syn-CIFAR100: {fid_value:.4f}")