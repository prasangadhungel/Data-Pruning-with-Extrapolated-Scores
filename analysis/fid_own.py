...
if __name__ == "__main__":
    ...
    for num_itr in range(3):
        for prune_percentage in [0.9, 0.8, 0.5]:
            print("Now processing Places365...")
            ...
            print(f"FID between Full Trainset and {int((1 - prune_percentage) * 100)}% Random Places trainset: {fid_value:.4f}")
            ...
            print(f"FID between Full Trainset and {int((1 - prune_percentage) * 100)}% Stratified Pruned Places trainset: {fid_value:.4f}")


            # subset based on scores
            json_path = "/nfs/homedirs/dhp/unsupervised-data-pruning/scores/prune/PLACES_365_zcoreset_1_5_31.json"
            ...
            print(f"FID between Full Trainset and Zcoreset Top {int((1 - prune_percentage) * 100)}% Places trainset: {fid_value:.4f}")