...
def main(cfg_path: str):
    ...
    for num_itr in range(cfg.experiment.num_iterations):
        ...
        for epoch in range(cfg.pruning.num_epochs):
            ...
            if epoch <= cfg.pruning.trajectory:
        ...
        model_name = f"{cfg.paths.models}/tdds_first"
        if cfg.dataset.for_extrapolation.value is True:
        ...
        output_path = f"{cfg.paths.scores}/{cfg.dataset.name}_tdds_first_{num_itr}"
